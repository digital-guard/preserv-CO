...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952070,'carlos',952070,'+proj=col_urban +lat_0=3.44188333333333 +lon_0=-76.5205625 +x_0=1061900.18 +y_0=872364.63 +h_0=1000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952070"
cd /tmp/sandbox/_pk17000000701_001; find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_MANZANAS*.shp" -exec sh -c "psql postgres://postgres@localhost/ingest1 -c 'DROP TABLE IF EXISTS pk17000000701101_p1_nsvia'; shp2pgsql -D   -s 952070 '{}' pk17000000701101_p1_nsvia | psql -q postgres://postgres@localhost/ingest1; psql postgres://postgres@localhost/ingest1 -c \"SELECT ingest.any_load('shp2sql','$$(find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_MANZANAS*.shp" | head -n 1)','nsvia_none','pk17000000701101_p1_nsvia','17000000701101','a3070e1b3136cae6068a6ecdd1f0b665d4b1430ca83429553db29ae72658e1f0.zip',array['IDMANZANA', 'IDBARRIOS', 'DEPAPRED', 'MUNIPRED', 'TIPO_AVALU', 'SECTOR', 'COMUNA', 'BARRIO', 'MANZANA', 'OBS'],5,1,True)\"; chmod -R a+rx . 2> /dev/null" \;
cd /tmp/sandbox/_pk17000000701_001; find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_MANZANAS_U*.shp" -exec sh -c "psql postgres://postgres@localhost/ingest1 -c 'DROP TABLE IF EXISTS pk17000000701101_p1_nsvia'; shp2pgsql -D   -s 952070 '{}' pk17000000701101_p1_nsvia | psql -q postgres://postgres@localhost/ingest1; psql postgres://postgres@localhost/ingest1 -c \"SELECT ingest.any_load('shp2sql','$$(find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_MANZANAS*.shp" | head -n 1)','nsvia_none','pk17000000701101_p1_nsvia','17000000701101','a3070e1b3136cae6068a6ecdd1f0b665d4b1430ca83429553db29ae72658e1f0.zip',array['IDMANZANA', 'IDBARRIOS', 'DEPAPRED', 'MUNIPRED', 'TIPO_AVALU', 'SECTOR', 'COMUNA', 'BARRIO', 'MANZANA', 'OBS'],5,1,False)\"; chmod -R a+rx . 2> /dev/null" \;
...
psql postgres://postgres@localhost/ingest1 -c "DROP  TABLE IF EXISTS pk17000000701101_p1_nsvia CASCADE"
@echo "Delete SRID 952070 configurado via PROJ.4 string:"
...
psql postgres://postgres@localhost/ingest1 -c "DELETE FROM spatial_ref_sys WHERE srid=952070;"
...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952070,'carlos',952070,'+proj=col_urban +lat_0=3.44188333333333 +lon_0=-76.5205625 +x_0=1061900.18 +y_0=872364.63 +h_0=1000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952070"
cd /tmp/sandbox/_pk17000000701_001; find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_TERRENO*.shp" -exec sh -c "psql postgres://postgres@localhost/ingest1 -c 'DROP TABLE IF EXISTS pk17000000701101_p1_parcel'; shp2pgsql -D   -s 952070 '{}' pk17000000701101_p1_parcel | psql -q postgres://postgres@localhost/ingest1; psql postgres://postgres@localhost/ingest1 -c \"SELECT ingest.any_load('shp2sql','$$(find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_TERRENO*.shp" | head -n 1)','parcel_full','pk17000000701101_p1_parcel','17000000701101','a3070e1b3136cae6068a6ecdd1f0b665d4b1430ca83429553db29ae72658e1f0.zip',array['DEPAPRED', 'MUNIPRED', 'SECTOR', 'COMUNA', 'BARRIO', 'MANZANA', 'TERRENO', 'PREDIO', 'NUMEPRED', 'NOM_EDIFIC', 'ETIQUETA', 'CONEXION', 'NPN as hnum'],5,1,True)\"; chmod -R a+rx . 2> /dev/null" \;
cd /tmp/sandbox/_pk17000000701_001; find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_TERRENOS_U*.shp" -exec sh -c "psql postgres://postgres@localhost/ingest1 -c 'DROP TABLE IF EXISTS pk17000000701101_p1_parcel'; shp2pgsql -D   -s 952070 '{}' pk17000000701101_p1_parcel | psql -q postgres://postgres@localhost/ingest1; psql postgres://postgres@localhost/ingest1 -c \"SELECT ingest.any_load('shp2sql','$$(find /tmp/sandbox/_pk17000000701_001 -path "*BASE_012022.shp/ARCEDITOR01_R_TERRENO*.shp" | head -n 1)','parcel_full','pk17000000701101_p1_parcel','17000000701101','a3070e1b3136cae6068a6ecdd1f0b665d4b1430ca83429553db29ae72658e1f0.zip',array['DEPAPRED', 'MUNIPRED', 'SECTOR', 'COMUNA', 'BARRIO', 'MANZANA', 'TERRENO', 'PREDIO', 'NUMEPRED', 'NOM_EDIFIC', 'ETIQUETA', 'CONEXION', 'NPN as hnum'],5,1,False)\"; chmod -R a+rx . 2> /dev/null" \;
...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952070,'carlos',952070,'+proj=col_urban +lat_0=3.44188333333333 +lon_0=-76.5205625 +x_0=1061900.18 +y_0=872364.63 +h_0=1000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952070"
cd /tmp/sandbox/_pk17000000701_001; shp2pgsql -D   -s 952070 "POT_2014.gdb_arcgis_10.5/Ejesviales/bcs_nomenclatura_ejes_viales.shp" pk17000000701201_p2_via | psql -q postgres://postgres@localhost/ingest1 2> /dev/null
